...
description: >-
  ...
  year. Use as a follow-up to the changers-statistics skill, once a portfolio
  manager has identified a high-change company, this skill drills into the
  actual text to show what changed. Triggers: "what changed for company X",
  "show me the added or removed risks for {company}", "diff the risk section
  for {company} in {year}", or any drill-in request after a changer leaderboard.
---
